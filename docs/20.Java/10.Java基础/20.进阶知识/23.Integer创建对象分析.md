...
![在这里插入图片描述](https://studynote-images.oss-cn-hangzhou.aliyuncs.com/Test-int-i.png)
...
![在这里插入图片描述](https://studynote-images.oss-cn-hangzhou.aliyuncs.com/Test-new-Integer.png)
...
![在这里插入图片描述](https://studynote-images.oss-cn-hangzhou.aliyuncs.com/Test-Integer-valueOf.png)
