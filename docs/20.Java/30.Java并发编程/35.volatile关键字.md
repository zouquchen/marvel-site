...
<img src="https://studynote-images.oss-cn-hangzhou.aliyuncs.com/CPU-Cache.png" alt="image-20220303112745947" style="zoom:50%;" />
...
2 保证某些变量的内存可见性。强制刷出各种 CPU 的缓存数据，因此CPU上的线程都能读取到这些数据的最新版本。
...
<img src="https://studynote-images.oss-cn-hangzhou.aliyuncs.com/Volatile-Store.png" alt="img" style="zoom:80%;" />
...
<img src="https://studynote-images.oss-cn-hangzhou.aliyuncs.com/Volatile-load.png" alt="img" style="zoom:80%;" />
